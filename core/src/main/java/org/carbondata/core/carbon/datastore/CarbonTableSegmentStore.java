...
public class CarbonTableSegmentStore {
     ...
     * singleton instance
     */
    private static final CarbonTableSegmentStore CARBONTABLESEGMENTSTORE =
            new CarbonTableSegmentStore();
    ...
    public CarbonTableSegmentStore() {
        tableSegmentMap =
                new ConcurrentHashMap<AbsoluteTableIdentifier, Map<Integer, TableSegment>>(
     ...
     *
     * @param segmentToTableBlocksInfos segment to table block info
    ...
    public List<TableSegment> loadAndGetBlocks(
        ...
        List<TableSegment> loadedBlocksList =
                new ArrayList<TableSegment>(CarbonCommonConstants.DEFAULT_COLLECTION_SIZE);
        // add the instance to lock map if it is not present
        tableLockMap.putIfAbsent(absoluteTableIdentifier, new Object());
        Iterator<Entry<Integer, List<TableBlockInfos>>> iteratorOverSegmentBlocksInfos =
        ...
        synchronized (lockObject) {
            ...
            Map<Integer, TableSegment> tableSegmentMapTemp =
            ...
            while (iteratorOverSegmentBlocksInfos.hasNext()) {
                ...
                TableSegment tableSegment = tableSegmentMapTemp.get(next.getKey());
     ...
     *
     * @param removeSegmentIds        segment to be removed
     * @param absoluteTableIdentifier absolute table identifier
     */
    public void removeTableBlocks(List<Integer> removeSegmentIds,
            AbsoluteTableIdentifier absoluteTableIdentifier) {
